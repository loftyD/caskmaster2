...
?>
	<div class="container">
        <h1>Dashboard</h1>
	        <?php if($latest > $_SERVER['app']->get("caskmaster.version")) { ?>
	        <div class="jumbotron">
	        	<div class="alert alert-danger">
	        		<p>Your Caskmaster Version is <strong><?=$_SERVER['app']->get("caskmaster.version");?></strong>. The latest version is <strong><?=$latest;?></strong><br />
